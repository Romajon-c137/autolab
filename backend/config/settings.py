...
AUTOLAB_STORAGE_ROOT = Path(os.environ.get("AUTOLAB_STORAGE_ROOT", BASE_DIR / "storage"))

WAZZUP_API_KEY = os.environ.get("WAZZUP_API_KEY", "").strip()
WAZZUP_CHANNEL_ID = os.environ.get("WAZZUP_CHANNEL_ID", "").strip()
WAZZUP_API_URL = os.environ.get(
    "WAZZUP_API_URL",
    "https://api.wazzup24.com/v3/message",
).strip()
WAZZUP_2FA_DRY_RUN = _env_bool("WAZZUP_2FA_DRY_RUN", default=False)
TWO_FACTOR_CODE_TTL_SECONDS = int(os.environ.get("TWO_FACTOR_CODE_TTL_SECONDS", "300"))
