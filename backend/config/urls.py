...
from inspections.protected_media import media_authorize, protected_media
...
urlpatterns = [
    ...
    path('api/milestones/1000/', milestone_1000, name='milestone-1000'),
    path('api/greetings/ilim-smile/', ilim_smile_greeting, name='ilim-smile-greeting'),
    ...
    path('api/media/<path:media_path>', protected_media, name='protected-media'),
    path('api/media-authorize/', media_authorize, name='media-authorize'),
